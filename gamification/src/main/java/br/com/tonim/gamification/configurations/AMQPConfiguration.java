package br.com.tonim.gamification.configurations;
...
public class AMQPConfiguration {
    ...
    @Bean
    public Binding correctAttempsBinding(final Queue queueGamification, final TopicExchange attemptsExchange) {
        return BindingBuilder.bind(queueGamification).to(attemptsExchange).with("attempt.correct");
    }
